...
function handleNewWordsEntered(event) {
  ...
  console.log(" === Inside handleNewWordEntered(), text", text)
  text.indexOf('fox')
...
function handleAddWordButtonClicked(event){
  console.log("==An add word vutton was clicked")
  ...
  if(word){
    ...
    var wordsContiner = document.querySelector('.words-container')
    wordsContiner.appendChild(wordElem)
